...
export type DMDialogue = (typeof DMDialogue)[number];

export const DMDefaultProps = {} as const satisfies Partial<Dialogue>;

export const DMDialogues: Record<DMDialogue, ReqDialogueProps> = {
	intro: {
		text: [
